...
public class ProcessTimeline extends AbstractProcessData {
	...
	public AbstractStack getStack(int sample) {
		return this.getCallPath(sample);
	}
	
	/** returns the call path corresponding to the sample given */
	private CallPath getCallPath(int sample) {
